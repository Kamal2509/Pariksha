            ...
            {show && <div className="fixed top-16 mt-2 left-0 z-40 w-64 h-screen p-4  overflow-y-auto  bg-white dark:bg-gray-800"  >
                ...
                <div className="py-4 overflow-y-auto">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <NavLink to={"/admin/categories"} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                        <NavLink to={"/admin/quizzes"} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <FontAwesomeIcon icon={faLightbulb} />
                                <span className="flex-1 ms-3 whitespace-nowrap">Quizzes</span>
                                </NavLink>
                        </li>
                        <li>
                        <NavLink to={"/admin/addQuiz"} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
