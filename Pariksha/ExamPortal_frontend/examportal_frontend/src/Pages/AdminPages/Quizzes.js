...
export const Quizzes = () => {
    ...
    return (
        <section className="bg-gray-50 dark:bg-gray-900 min-w-full max-w-screen-2xl  mx-auto  text-justify min-h-screen">
            <SideNavbar />
            <div className='max-w-6xl mx-auto p-4 text-2xl font-bold ' >
                All Quizzes
                {/* <hr className='mt-2' /> */}
                {
                    quizzes.map(item => (
                        <div className='flex m-2 py-2 bg-white border border-l-8 rounded shadow text-gray-700 dark:text-white'>
                            ...
                            <div className='ml-4 text-base font-normal w-full'>
                                ...
                                <div className='mt-2'>
                                    <button type="button" className="text-white bg-primary-400 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Questions</button>
                                    ...
                                    <button type="button" className="text-white bg-primary-400 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Update</button>
                                    ...
                                    <button type="button" className="text-white bg-primary-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Delete</button>
                                </div>
